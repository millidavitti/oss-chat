...
import useOauthInterface from "../interface/use-oauth-interface";

export default function Oauth() {
	const { signUpWithGoogle } = useOauthInterface();
	return (
		<>
			<Flex flex='column' className='max-w-[480px] w-full gap-3'>
				<Flex className='justify-center items-center grow gap-3'>
					...
					<p className='body-medium sm:body-large'>Or sign up with</p>
					<div className='grow border border-b-1 border-system-outline' />
				</Flex>
				<Button
